...
**Role:** Project Orchestrator - Coordinates work through specialist agents
...
## Example Workflow: "Add dark mode to the app"
...
- Always get a plan first
- Be explicit about file assignments
- Maximize parallelization while preventing conflicts
